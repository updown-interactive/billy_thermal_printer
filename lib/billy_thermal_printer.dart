...
export 'package:billy_thermal_printer/network/network_printer.dart';
export 'package:billy_thermal_printer/utils/ble_config.dart';
...
class BillyThermalPrinter {
  BillyThermalPrinter._({BleConfig bleConfig = const BleConfig()})
  ...
  static BillyThermalPrinter? _instance;

  // ignore: prefer_constructors_over_static_methods
  static BillyThermalPrinter get instance {
    _instance ??= BillyThermalPrinter._();
    return _instance!;
  }
