...
import 'billy_thermal_printer_method_channel.dart';
import 'utils/printer.dart';

abstract class BillyThermalPrinterPlatform extends PlatformInterface {
  BillyThermalPrinterPlatform() : super(token: _token);
  static final Object _token = Object();
  static BillyThermalPrinterPlatform _instance =
      MethodChannelBillyThermalPrinter();
  static BillyThermalPrinterPlatform get instance => _instance;

  static set instance(BillyThermalPrinterPlatform instance) {
